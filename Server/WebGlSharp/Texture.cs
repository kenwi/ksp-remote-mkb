...
namespace WebGL
{
    public class Texture
    {
        ...
        public static async Task<Texture> BuildAsync(WebGLContext gl, int[] image, int width = 100, int height = 100)
        {
            ...
            await gl.TexImage2DAsync(Texture2DType.TEXTURE_2D, 0, PixelFormat.RGBA, width, height, PixelFormat.RGBA, PixelType.UNSIGNED_BYTE, image);
        ...
        public async Task UpdateData(int[] image)
        {
            ...
            await _gl.TexImage2DAsync(Texture2DType.TEXTURE_2D, 0, PixelFormat.RGBA, _width, _height, PixelFormat.RGBA, PixelType.UNSIGNED_BYTE, image);
